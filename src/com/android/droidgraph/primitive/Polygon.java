...
public class Polygon extends SGLNode{
	...
	public Polygon(float[] verts) {
		...
		colors = new float[] { 1.0f, 0.0f, 1.0f, 1.0f, // Bottom right color
				0.0f, 0.0f, 1.0f, 1.0f, // Top Right color
				1.0f, 0.0f, 1.0f, 1.0f, // Bottom left color
				0.0f, 0.0f, 1.0f, 1.0f // Top Left color
		};
